...
export default function RegisterSASC({ onRegistered }) {
  ...
  const handleSubmit = () => {
    const studentNumber = `SASC-${new Date().getFullYear()}-${Math.floor(Math.random() * 9000 + 1000)}`;
    onRegistered({
      ...form,
      studentNumber,
      photo,
    ...
    <div className="p-8 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="w-28 h-32 rounded-xl border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden cursor-pointer hover:border-blue-400 transition"
              ...
              style={{ borderColor: photo ? '#1B1F8A' : undefined }}>
              {photo
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className={labelClass}>Home Telephone</label>
              <input name="homeTel" value={form.homeTel} onChange={handleChange} className={inputClass} placeholder="Optional" />
            </div>
            <div>
              <label className={labelClass}>South African Citizen? *</label>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelClass}>Name of Previous School *</label>
              ...
              <div>
                <label className={labelClass}>Qualification / Grade Passed *</label>
                <input name="qualificationObtained" value={form.qualificationObtained} onChange={handleChange} className={inputClass} placeholder="e.g. Grade 12 / NQF Level 4" required />
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={doc.key} className="border-2 border-dashed border-gray-300 rounded-xl p-6">
                ...
                {doc.state && (
                  <p className="text-sm mt-2 font-medium" style={{ color: '#8DC63F' }}>
                    ✓ {doc.state.name} uploaded
                  </p>
                )}
              </div>
            ))}
          ...
          <div className="mt-6 p-4 rounded-xl bg-yellow-50 border border-yellow-200">
            <p className="text-sm text-yellow-800">
              <strong>Registration Fee:</strong> R500 Admin + R700 Admin fee required. 
              Please upload proof of payment above.
            </p>
          </div>
      ...
      {step === 4 && (
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <label className={labelClass}>Who is paying for this account? *</label>
            ...
            <div>
              <label className={labelClass}>Name of Person / Entity *</label>
          ...
          <div className="mt-6 p-4 rounded-xl bg-blue-50 border border-blue-200">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <p className="text-sm text-blue-800">
                <strong>Payer Declaration:</strong> I accept full responsibility for tuition fees payment and agree to pay monthly instalments before the 3rd of each month. I agree that fees are payable even if the student does not attend lectures.
              </p>
            </label>
          </div>
          ...
          <div className="p-4 rounded-xl bg-gray-50 border border-gray-200 mb-6">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <p className="text-xs text-gray-600">
                <strong>Student Declaration:</strong> I declare that all information provided is true and correct. I agree to comply with all SA Shepherd College rules, regulations and policies. I understand that fees are payable in full regardless of attendance.
              </p>
            </label>
          </div>
